...
public class JsAesWebshell implements Cryption {
    ...
    public void init(ShellEntity context) {
        ...
        // 设置 Content-Type 为 application/json（因为 encode 返回 JSON）
